...
We have deployed a goerli verify contract at: 0x1ed91218c8cd4b0c5dd901e3537c83113c5bec05. Developers can use this to verify the proof.
...
1. Setting the environment variables:
   ...
   **NOTE: you should use your own Postgres database url to replace the relative fields in DATABASE_URL variable in both cases, and you should use your own goerli secret key in VERIFIER_CHAIN_URL. **
